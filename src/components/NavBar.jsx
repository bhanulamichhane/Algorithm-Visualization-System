...
export function NavBar() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <h3>Algorithm Visualization System(vizAlgo)</h3>
        <a href="https://github.com/bhanulamichhane/Algorithm-Visualization-System" target="_blank"><AiFillGithub style={{ fontSize: "1.5rem" }} /></a>
      </div>
